...
# Sources
CLIENT_SOURCES=src/message.c src/logging.c src/transmitmsg.c src/connection.c src/client.c
SERVER_SOURCES=src/message.c src/logging.c src/transmitmsg.c src/connection.c src/server.c
